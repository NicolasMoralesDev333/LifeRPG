...
export default function LifeRPGDashboard() {
  ...
  if (isAuthLoading) {
    return <AuthLoadingScreen toastNode={toastNode} />;
  }
    ...
    <main className="relative min-h-screen overflow-hidden bg-slate-950 px-4 py-5 text-slate-100 sm:px-6 lg:px-8">
      ...
      <section className="relative mx-auto flex w-full max-w-7xl flex-col gap-5">
        ...
        >
          ...
          <Suspense
            fallback={
              <div className="border-2 border-cyan-300/70 bg-slate-950/[0.88] p-5 font-mono text-sm font-black uppercase text-cyan-100 shadow-[0_0_38px_rgba(34,211,238,0.18)] [clip-path:polygon(0_0,calc(100%-18px)_0,100%_18px,100%_100%,18px_100%,0_calc(100%-18px))]">
                &gt; Invocando El Oráculo...
              </div>
            }
          >
            <OraclePanel
